...
extension JJBlockRouter {
    internal struct PatternTokenBuilder {
        private var scanTerminals: [JJBlockRouter.Scanner.Terminal] = []
    }
}

extension JJBlockRouter.PatternTokenBuilder {
    /// 添加 /
...
extension JJBlockRouter.PatternTokenBuilder {
    func build() -> [JJBlockRouter.RoutingPatternToken] {
        var tokens: [JJBlockRouter.RoutingPatternToken] = []
